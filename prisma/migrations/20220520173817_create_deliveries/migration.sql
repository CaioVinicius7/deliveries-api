...
-- AddForeignKey
ALTER TABLE "deliveries" ADD CONSTRAINT "deliveries_id_deliveyman_fkey" FOREIGN KEY ("id_deliveyman") REFERENCES "deliveryman"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
